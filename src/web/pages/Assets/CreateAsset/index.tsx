...
interface CreateAssetDataFormProps {
	name: string;
...
const CreateAssetFormSchema = yup.object().shape({
...
export const CreateAsset: FCWithLayout = () => {
	...
	const createAsset = useMutation(
		async (asset: CreateAssetDataFormProps) => {
	...
	const { register, handleSubmit, formState } = useForm({
		resolver: yupResolver(CreateAssetFormSchema),
	});
	const { errors } = formState;

	const handleCreateAsset: SubmitHandler<CreateAssetDataFormProps> = async (
		values
	) => {
