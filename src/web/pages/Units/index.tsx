...
export const UnitsPage: FCWithLayout = () => {
	const isWideVersion = useBreakpointValue({
		base: false,
		lg: true,
	});

	const { data, isLoading, error, refetch, isFetching } = useUnits();
